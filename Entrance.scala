...
object Entrance extends App {
  ...
  override def main(args: Array[String]) {  //scala main func. does not exists, create spark session
    val spark = SparkSession
      .builder()
      .appName("CSE511-Project-ardakocaman") // YOU NEED TO CHANGE YOUR GROUP NAME
